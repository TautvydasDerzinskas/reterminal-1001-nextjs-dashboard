...
export const HumidityIcon = ({ size = 16, color = 'currentColor' }: Props) => (
  <svg stroke={color} fill={color} strokeWidth="0" viewBox="0 0 384 512" height={size} width={size} xmlns="http://www.w3.org/2000/svg">
